<?php
    ...
    define('PAGE_TITLE', "Attendance V2 => Meeting/ Event Extra Times");
    define('PAGE_DESC', "View Scheduled Meeting/ Event(s) Extra Times");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/setup-view/times', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <attendance-setup-view-times email="<?= $user_info['pdcu_email']; ?>" 
