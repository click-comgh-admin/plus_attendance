<?php
    ...
    define('PAGE_DESC', "Add Schedule Meeting/ Event Agenda");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/setup-form/add-agenda', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <attendance-setup-form-add-agenda email="<?= $user_info['pdcu_email']; ?>" 
