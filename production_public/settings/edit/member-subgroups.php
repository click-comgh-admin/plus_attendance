<?php
    ...
    define('PAGE_DESC', "Update Schedule Meeting/ Event Member Sub-Groups");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/setup-form/edit-member-subgroups', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <attendance-setup-form-edit-member-subgroups email="<?= $user_info['pdcu_email']; ?>" 
