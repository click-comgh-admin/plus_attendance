<?php
    ...
    define('PAGE_DESC', "Update Schedule Meeting/ Event Agenda");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/setup-form/edit-agenda', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <attendance-setup-form-edit-agenda email="<?= $user_info['pdcu_email']; ?>" 
