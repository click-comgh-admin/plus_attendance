<?php
    ...
    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/setup-form/list-agendas', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <attendance-setup-form-view-agendas email="<?= $user_info['pdcu_email']; ?>" 
                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                        </attendance-setup-form-view-agendas>
                    </div>
