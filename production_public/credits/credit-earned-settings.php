<?php
    ...
    define('PAGE_TITLE', "Attendance => Credit Earned");
    define('PAGE_DESC', "View Credit Earned Settings");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/credit_earned/settings', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <attendance-credit-earned-settings CLIENT_ID="<?= $user_info['pdcu_account_id']; ?>">
                        </attendance-credit-earned-settings>
                    </div>
