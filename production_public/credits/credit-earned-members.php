<?php
    ...
    define('PAGE_TITLE', "Attendance => Member Credit Earned");
    define('PAGE_DESC', "View Member Credit Earned");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/credit_earned/members', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <attendance-credit-earned-members CLIENT_ID="<?= $user_info['pdcu_account_id']; ?>">
                        </attendance-credit-earned-members>
                    </div>
