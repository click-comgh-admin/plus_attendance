"use strict";!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports.webpackNumbers=t():e.webpackNumbers=t()}(self,(()=>(self.webpackChunkwebpackNumbers=self.webpackChunkwebpackNumbers||[]).push([[6925],{6559:(e,t,n)=>{n.r(t),n.d(t,{PdbAttendanceClockingAttendees:()=>F});var i,l,r,o=n(5862),s=n(8393),c=n(5248),d=(n(9261),n(3313),n(6883),n(3683),n(4657),n(7725)),a=(n(3690),n(7052)),u=n(771),m=n(3600),p=n(4672),h=n(7553),b=n(2869),f=n(2368),y=(n(5517),n(72)),g=n(4115),v=n(5069),_=n(2892),w=(n(3629),n(4843)),$=n(5458),k=n(3437),x=n(660),S=n(8786),C=n(9605),I=(n(7933),n(9987),n(5647),n(8276)),A=n(596),B=n(9665),E=n(8092),N=n(1302),T=n(7108),O=function(e,t,n,i){var l,r=arguments.length,o=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(o=(r<3?l(o):r>3?l(t,n,o):l(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},G=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},M=function(e,t,n,i){return new(n||(n=Promise))((function(l,r){function o(e){try{c(i.next(e))}catch(e){r(e)}}function s(e){try{c(i.throw(e))}catch(e){r(e)}}function c(e){var t;e.done?l(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,s)}c((i=i.apply(e,t||[])).next())}))};let F=class extends o.oi{constructor(){super(),this.meetingEventId=0,this.meetingEventIdEnc=null,this.datatablePathUrl="attendance/meeting-event/attendance/attendees",this._genders=[],this._clockingTypes=[],this._memberCategories=[],this._scheduleGroups=[],this._scheduleSubGroups=[],this._activeBranchId=null,this._memberType=1,this.__members=null,this._hasSetup=!1,this._pageButtonAccess=!1}set _members(e){this.__members=e,this.requestUpdate()}get _members(){return this.__members}connectedCallback(){const e=Object.create(null,{connectedCallback:{get:()=>super.connectedCallback}});return M(this,void 0,void 0,(function*(){e.connectedCallback.call(this),(0,B.f)().then((()=>this._hasSetup=!0)),this.getMeetingEventId();const t=(0,d.hk)();this._activeBranchId=null===t?null:[t],this.filterBox=new f.L({selectors:{container:this.filterSectionContextContainer,form:this.filterSectionContextForm,filterSectionContextBtn:this.filterSectionContextBtn}}),yield this.getGenders(),yield this.getClockingType(),yield this.getClientMemberCategories(),yield this.getAttendanceScheduleGroup(),yield this.getAttendanceScheduleSubGroup()}))}disconnectedCallback(){}render(){var e;if(this._hasSetup){if(null===(e=(0,E.H)())||void 0===e?void 0:e.expiration_date.expired)return o.dy`<account-expired-component></account-expired-component>`;if(this._pageButtonAccess=(0,N.OR)(T.W.attendees),!(0,N.H)({pageId:T.W.attendees,viewType:"Both"},!1))return o.dy`<no-page-entry-component></no-page-entry-component>`}return 0===this.meetingEventId||null===this.meetingEventId||Number.isNaN(this.meetingEventId)?o.dy`
    ...
    `}firstUpdated(){this.filterBox=new f.L({selectors:{container:this.filterSectionContextContainer,form:this.filterSectionContextForm,filterSectionContextBtn:this.filterSectionContextBtn},unmutableInputNames:[{name:"meeting-event-id",value:this.meetingEventIdEnc}]})}getMeetingEventId(){let e=(0,p.Jx)("meeting-event-id"),t=null!==e?(0,a.t)(e):null;this.meetingEventId=Number.isNaN(t)?null:Number(t),this.meetingEventIdEnc=(0,a.h)(String(this.meetingEventId),!0)}get filterForm(){let e=o.dy``;const t=(0,p.O1)(),n="filter_date",i="filter_gender",l="filter_name",r="filter_identity",s="filter_member_category",c="filter_group",d="filter_subgroup",a="filter_from_age",u="filter_to_age";let m=null,h=null,b=null,f=null,y=null,g=null,v=null,_=null,w=null;for(const e in t){let o=String(t[e]);if(o=""===o?null:o,e===n)if(null===o)m="";else{const e=new Date(o).toLocaleDateString("en-US",{day:"2-digit",month:"2-digit",year:"numeric",formatMatcher:"best fit"}).split("/");m=[e[2],e[0],e[1]].join("-")}e===i&&(h=o),e===l&&(b=o),e===r&&(f=o),e===s&&(y=Number(o)),e===c&&(g=Number(o)),e===d&&(v=Number(o)),e===a&&(_=Number(o)),e===u&&(w=Number(o))}const k=o.dy`
      ...
      <div class="col-xl-4 col-md-6">
        <div class="form-input-container !block">Gender
          <mwc-select name="${i}" id="${i}" label="Select Gender" outlined required>
            ${this._genders.map((e=>null===h?o.dy`<mwc-list-item value="${e.id}">${e.name}</mwc-list-item>`:Number(h)===e.id?o.dy`<mwc-list-item value="${e.id}" selected>${e.name}</mwc-list-item>`:o.dy`<mwc-list-item value="${e.id}">${e.name}</mwc-list-item>`))}
          </mwc-select>
        </div>
      </div>`,A=o.dy`
      <div class="col-xl-4 col-md-6">
