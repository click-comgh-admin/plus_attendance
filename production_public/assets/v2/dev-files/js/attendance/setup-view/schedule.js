      ...
      ${this._scheduleDays.map(((e,t,a)=>n.html`
          <tr class="mdc-data-table__row">
            ...
            <td class="mdc-data-table__cell whitespace-pre-line" scope="row">
              ${(0,l.getDate)(e.startDate,{dateStyle:"medium"})}
              ${t+1==a.length?"...":""}
            </td>
            <td class="mdc-data-table__cell whitespace-pre-line" scope="row">
