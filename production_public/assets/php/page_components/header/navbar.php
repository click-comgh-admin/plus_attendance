...
$accountsAccessPageKey = base64_encode("/admin/user/accounts");
$myAccountAccessPageKey = base64_encode("/admin/user/my-account");
$accountSettingsAccessPageKey = base64_encode("/account/settings/settings");
?>
                ...
                <div class="app-header__content">
                    ...
                    <?php /** 
                        ...
                        <ul class="header-menu nav">
                            ...
                            ?>
                            <li class="btn-group nav-item">
                                <a href="<?= DATABASE_BASE_URL; ?>app-reroute?permission-key=<?= $permissionKey; ?>&access-page-key=<?= $accountsAccessPageKey; ?>" type="button" class="nav-link">
                                    <i class="nav-link-icon fa fa-users"></i> Accounts
                                </a>
                            </li>
                            <?php /** <li class="dropdown nav-item">
                                    ...
                                    <div class="widget-content-left">
                                        <div class="btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                                <a href="<?= DATABASE_BASE_URL; ?>app-reroute?permission-key=<?= $permissionKey; ?>&access-page-key=<?= $myAccountAccessPageKey; ?>" type="button" tabindex="0" class="dropdown-item <?= ($url_endpoint == "my-account") ? "active": ""; ?>">User Account</a>
                                                <a href="<?= DATABASE_BASE_URL; ?>app-reroute?permission-key=<?= $permissionKey; ?>&access-page-key=<?= $accountsAccessPageKey; ?>" type="button" tabindex="0" class="dropdown-item <?= ($url_endpoint == "accounts") ? "active": ""; ?>">Accounts</a>
                                                <!-- <pdb-branch-button></pdb-branch-button> -->
                                                <div branch_button_selector></div>
                                                <div tabindex="-1" class="dropdown-divider"></div>
                                                <a href="<?= DATABASE_BASE_URL; ?>app-reroute?permission-key=<?= $permissionKey; ?>&access-page-key=<?= $accountSettingsAccessPageKey; ?>" type="button" tabindex="0" class="dropdown-item <?= ($url_endpoint == "settings" || $url_endpoint == "logo" || $url_endpoint == "leaders") ? "active": ""; ?>">Settings</a>
                                                <?php /** 
                                                    if (isset($__SYSTEM_VARIABLES['AccountInfoId']) && AccountInfoId === _AccountInfoId) { ?>
