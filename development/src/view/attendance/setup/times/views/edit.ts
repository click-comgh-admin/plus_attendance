...
import { PATCH_AttendanceAddScheduleTime } from '@@addons/network/attendance/setup/time/patch';
import './form/inputs';


@customElement("edit-times")
export class EditTimes extends LitElement {
  constructor() { super(); }
  ...
  async connectedCallback() {
    ...
    this.timeID = this.timeData.length>0&&this.timeData[0]!==undefined?this.timeData[0].id: 0;

    console.log({"this.timeData--this.timeData": this.timeData})
  }
  ...
  async submitForm(e: PointerEvent) {
    ...
    // console.log({ e });
      ...
      await PATCH_AttendanceAddScheduleTime(this.timeID, startTime, closeTime);
      this.showDialog();
  }
