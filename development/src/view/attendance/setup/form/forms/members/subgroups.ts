...
import { POST_AttendanceAddScheduleSubGroupMember } from '@@addons/network/attendance/setup/subgroup/post member';


@customElement("attendance-setup-form-member-subgroups")
export class AttendanceSetupFormMemberSubgroups extends LitElement {
  constructor() { super(); }
  ...
  async submitForm(e: PointerEvent) {
    ...
    // }
    // await POST_AttendanceAddScheduleSubGroupMultiple();
    await POST_AttendanceAddScheduleSubGroupMember();
  }
  ...
  private async getAttendanceScheduleSubGroup() {
    const _networkResponse = await GET_AttendanceScheduleSubGroupMember<MeetingEventScheduleSubGroup_I>(
