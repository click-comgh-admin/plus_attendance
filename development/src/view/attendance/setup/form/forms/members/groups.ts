...
import { POST_AttendanceAddScheduleGroupMember } from '@@addons/network/attendance/setup/group/post_member';


@customElement("attendance-setup-form-member-groups")
export class AttendanceSetupFormMemberGroups extends LitElement {
  constructor() { super(); }
  ...
  async submitForm(e: PointerEvent) {
    ...
    // }
    // await POST_AttendanceAddScheduleGroupMultiple();
    await POST_AttendanceAddScheduleGroupMember();
  }
  ...
  private async getAttendanceScheduleGroup() {
    const _networkResponse = await GET_AttendanceScheduleMemberGroup<MeetingEventScheduleGroup_I>(
