...
import '../../../forms/members/subgroups';
import '../../links';
...
@customElement("attendance-setup-form-edit-member-subgroups")
export class AttendanceSetupFormEditMemberSubgroups extends LitElement {
  constructor() {
    super();
  }
