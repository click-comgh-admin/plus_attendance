...
cd "Y:\htdocs\AMG\plus_db\client_dashboards\version_one\plus_attendance\development\src\addons\interfaces\attendance\credit_earned\member"
echo Directory Open && echo Generating File
quicktype -l ts main.json -t MemberCreditEarnedModel -o index.ts --nice-property-names --prefer-unions --all-properties-optional && echo Type File Generated Successfully!
...
@REM        WITH } else if (typeof typ === "object") {
@REM            return "";
@REM        }
