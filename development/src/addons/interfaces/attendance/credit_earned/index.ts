// To parse this data:
//
//   import { Convert, CreditEarnedModel } from "./file";
//
//   const creditEarnedModel = Convert.toCreditEarnedModel(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.
export interface CreditEarnedFiltersModel {
    id: number;
    name: string;
}

export interface CreditEarnedModel {
    id?:            number;
    clientID?:      ClientID;
    branchIDS?:     BranchI[];
...
export interface ScheduleID {
    ...
    clientID?:                  ClientID;
    branchID?:                  BranchI;
    memberCategoryID?:          AccountCategory | null;
    meetingSpan?:               number;
    startTime?:                 string;
    closeTime?:                 string;
    latenessTime?:              string;
...
export interface MeetingCategory {
    ...
    memberCategoryID?: AccountCategory;
    updatedBy?:        number;
    updateDate?:       Date;
    date?:             Date;
}
...
export class Convert {
    public static toCreditEarnedModel(json: string): CreditEarnedModel {
        return cast(JSON.parse(json), r("CreditEarnedModel"));
    }

    public static creditEarnedModelToJson(value: CreditEarnedModel): string {
        return JSON.stringify(uncast(value, r("CreditEarnedModel")), null, 2);
    }
}
...
export const typeMap: any = {
    "CreditEarnedModel": o([
        ...
        { json: "branchIds", js: "branchIDS", typ: u(null, a(r("BranchI"))) },
        { json: "scheduleIds", js: "scheduleIDS", typ: u(null, a(r("ScheduleID"))) },
        { json: "memberIds", js: "memberIDS", typ: u(null, a(r("MemberID"))) },
        { json: "type", js: "type", typ: u(null, r("Duration")) },
        { json: "duration", js: "duration", typ: u(null, r("Duration")) },
        { json: "durationValue", js: "durationValue", typ: u(null, "") },
        { json: "sign", js: "sign", typ: u(null, r("Duration")) },
        { json: "currency", js: "currency", typ: u(null, "") },
        { json: "unit", js: "unit", typ: u(null, "") },
    ...
    "ClientID": o([
        ...
        { json: "accountCategory", js: "accountCategory", typ: u(null, r("AccountCategory")) },
    ...
    "MemberInfo": o([
        ...
        { json: "categoryInfo", js: "categoryInfo", typ: u(null, r("AccountCategory")) },
    ], false),
    "UpdatedByInfo": o([
        { json: "id", js: "id", typ: u(null, 0) },
        { json: "firstname", js: "firstname", typ: u(null, "") },
    ...
    "ScheduleID": o([
        ...
        { json: "memberCategoryId", js: "memberCategoryID", typ: u(null, u(r("AccountCategory"), null)) },
    ...
    "MeetingCategory": o([
        ...
        { json: "memberCategoryId", js: "memberCategoryID", typ: u(null, r("AccountCategory")) },
        { json: "updatedBy", js: "updatedBy", typ: u(null, 0) },
        { json: "updateDate", js: "updateDate", typ: u(null, Date) },
        { json: "date", js: "date", typ: u(null, Date) },
    ], false),
