...
export async function POST_AttendanceAddScheduleTime(): Promise<any> {
  ...
  const url = CONSTANTS.URLS.AKWAABA_API_BASE_URL + 'attendance/meeting-event/time',
    formContainer: HTMLFormElement = document.querySelector('[make-general-posts="add-schedule-time"]'),
