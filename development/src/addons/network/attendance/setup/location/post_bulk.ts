...
export async function POST_AttendanceAddScheduleLocationBulk(dateInfos: Array<MemberMeetingEventDateFormInputModel>): Promise<any> {

  const _get_cookie = getUserLoginInfoCookie();
  // console.log({_get_cookie});

  const url = CONSTANTS.URLS.AKWAABA_API_BASE_URL + 'attendance/meeting-event/location/bulk',
