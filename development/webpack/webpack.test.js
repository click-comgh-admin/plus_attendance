...
module.exports = [{
    ...
    // stats: 'errors-only',
    output: {
        filename: '../../production_public/assets/v2/prod-test-files/js/[name].js',
        chunkFilename: '../../production_public/assets/v2/prod-test-files/js/[name].chunk.js',
    ...
    plugins: [
        new MiniCssExtractPlugin({
            ...
            filename: "../../production_public/assets/v2/prod-test-files/css/[name].css",
            chunkFilename: "../../production_public/assets/v2/prod-test-files/css/[id].css",
        }),
        new BundleTracker({
            filename: '../production_public/assets/v2/webpack-stats.json',
            publicPath: 'https://clock-2.akwaabasoftware.com/',
        }),
    ],
    externals: {
        lodash: {
